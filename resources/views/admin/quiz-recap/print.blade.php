          ...
          <div class="row">
            <div class="col-md-12">
              <form action="">
                              ...
                              <tbody>
                                @foreach ($quiz_students as $quizStudent)
                                  <tr>
                                    ...
                                    <td>{{ $quizStudent->student->school->name }}</td>
                ...
                <div class="row">
                  <div class="col-md-12">
                    <a href="{{ route('filament.admin.resources.quiz-recaps.view', ['record' => $quiz->id]) }}">
                      <button type="button" class="btn btn-primary fs-6 print-button">
                        <i class="bi bi-arrow-left"></i> Kembali
                      </button>
                    </a>
                    <button type="button" class="btn btn-primary fs-6 print-button" onclick="window.print()">
