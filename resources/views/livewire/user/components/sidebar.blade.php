<aside id="sidebar"
  ...
  <nav class="space-y-4">
    <a wire:navigate href="{{ route('home') }}"
      ...
      <i class="fa-solid fa-house {{ Request::is('/') ? 'text-white' : '' }}"></i>
    ...
    <a wire:navigate href="{{ route('quiz.index') }}"
      ...
      <i class="fa-solid fa-pen-to-square {{ Request::is('quiz') ? 'text-white' : '' }}"></i>
    ...
    <a wire:navigate href="{{ route('quiz.history') }}"
      ...
      <i class="fa-solid fa-clock-rotate-left {{ Request::is('quiz/history') ? 'text-white' : '' }}"></i>
