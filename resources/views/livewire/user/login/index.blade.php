<div class="flex h-screen">
  ...
  <div class="hidden basis-6/12 bg-cover bg-center bg-no-repeat md:block"
    style="background-image: url('{{ asset('images/login-bg.webp') }}')">
    <div class="grid h-full w-full place-items-center bg-[#14929a]/[.65] backdrop-blur-sm">
      <div class="w-6/12 px-2 text-white">
        ...
        <p class="text-end">
          <i class="fa-solid fa-angle-up rotate-[135deg] text-4xl font-black"></i>
        </p>
      </div>
    </div>
  </div>
